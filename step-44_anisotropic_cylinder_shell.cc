      ...
      Tensor<4, dim> get_Jc() const
        {
          ...
          std::cout<<"tmp1"<<tmp1[0][0][0][0]<<" "<<tmp1[0][0][0][1]<<" "<<tmp1[0][0][0][2]<<std::endl;
          std::cout<<tmp1[0][0][1][0]<<" "<<tmp1[0][0][1][1]<<" "<<tmp1[0][0][1][2]<<std::endl;
          std::cout<<tmp1[0][0][2][0]<<" "<<tmp1[0][0][2][1]<<" "<<tmp1[0][0][2][2]<<std::endl;
          Tensor<4, dim> tmp2 = get_Jc_iso4();
          std::cout<<"tmp2"<<tmp2[0][0][0][0]<<" "<<tmp2[0][0][0][1]<<" "<<tmp2[0][0][0][2]<<std::endl;
          std::cout<<tmp2[0][0][1][0]<<" "<<tmp2[0][0][1][1]<<" "<<tmp2[0][0][1][2]<<std::endl;
          std::cout<<tmp2[0][0][2][0]<<" "<<tmp2[0][0][2][1]<<" "<<tmp2[0][0][2][2]<<std::endl;          
