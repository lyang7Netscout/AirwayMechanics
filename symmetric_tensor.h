//---------------------------------------------------------------------------
//    $Id: symmetric_tensor.h 25743 2012-07-31 15:26:04Z bangerth $
//
...
namespace internal
{
  ...
  */
  ...
  inline
  Tensor<4,3,Number>
  conversion (const Tensor<2,6,Number> &data)
  {
    Number t[3][3][3][3];
    t[0][0][0][0] = data[0][0];  t[0][0][0][1] = data[0][3];  t[0][0][0][2] = data[0][4];
    t[0][0][1][0] = data[0][3];  t[0][0][1][1] = data[0][1];  t[0][0][1][2] = data[0][5];
    t[0][0][2][0] = data[0][4];  t[0][0][2][1] = data[0][5];  t[0][0][2][2] = data[0][2];
//    t[0][0] = {{data[0][0], data[0][3], data[0][4]},
//               {data[0][3], data[0][1], data[0][5]},
//               {data[0][4], data[0][5], data[0][2]}};
    t[1][1][0][0] = data[1][0];  t[1][1][0][1] = data[1][3];  t[1][1][0][2] = data[1][4];
    t[1][1][1][0] = data[1][3];  t[1][1][1][1] = data[1][1];  t[1][1][1][2] = data[1][5];
    t[1][1][2][0] = data[1][4];  t[1][1][2][1] = data[1][5];  t[1][1][2][2] = data[1][2];
//    t[1][1] = {{data[1][0], data[1][3], data[1][4]},
//               {data[1][3], data[1][1], data[1][5]},
//               {data[1][4], data[1][5], data[1][2]}};
    t[2][2][0][0] = data[2][0];  t[2][2][0][1] = data[2][3];  t[2][2][0][2] = data[2][4];
    t[2][2][1][0] = data[2][3];  t[2][2][1][1] = data[2][1];  t[2][2][1][2] = data[2][5];
    t[2][2][2][0] = data[2][4];  t[2][2][2][1] = data[2][5];  t[2][2][2][2] = data[2][2]; 
//    t[2][2] = {{data[2][0], data[2][3], data[2][4]},
//               {data[2][3], data[2][1], data[2][5]},
//               {data[2][4], data[2][5], data[2][2]}}; 
    t[1][0][0][0] = data[3][0];  t[1][0][0][1] = data[3][3];  t[1][0][0][2] = data[3][4];
    t[1][0][1][0] = data[3][3];  t[1][0][1][1] = data[3][1];  t[1][0][1][2] = data[3][5];
    t[1][0][2][0] = data[3][4];  t[1][0][2][1] = data[3][5];  t[1][0][2][2] = data[3][2]; 
    t[0][1][0][0] = data[3][0];  t[0][1][0][1] = data[3][3];  t[0][1][0][2] = data[3][4];
    t[0][1][1][0] = data[3][3];  t[0][1][1][1] = data[3][1];  t[0][1][1][2] = data[3][5];
    t[0][1][2][0] = data[3][4];  t[0][1][2][1] = data[3][5];  t[0][1][2][2] = data[3][2];
//    t[1][0] = t[0][1] = {{data[3][0], data[3][3], data[3][4]},
//               {data[3][3], data[3][1], data[3][5]},
//               {data[3][4], data[3][5], data[3][2]}};
    t[2][0][0][0] = data[4][0];  t[2][0][0][1] = data[4][3];  t[2][0][0][2] = data[4][4];
    t[2][0][1][0] = data[4][3];  t[2][0][1][1] = data[4][1];  t[2][0][1][2] = data[4][5];
    t[2][0][2][0] = data[4][4];  t[2][0][2][1] = data[4][5];  t[2][0][2][2] = data[4][2]; 
    t[0][2][0][0] = data[4][0];  t[0][2][0][1] = data[4][3];  t[0][2][0][2] = data[4][4];
    t[0][2][1][0] = data[4][3];  t[0][2][1][1] = data[4][1];  t[0][2][1][2] = data[4][5];
    t[0][2][2][0] = data[4][4];  t[0][2][2][1] = data[4][5];  t[0][2][2][2] = data[4][2];
//    t[2][0] = t[0][2] = {{data[4][0], data[4][3], data[4][4]},
//               {data[4][3], data[4][1], data[4][5]},
//               {data[4][4], data[4][5], data[4][2]}};
    t[2][1][0][0] = data[5][0];  t[2][1][0][1] = data[5][3];  t[2][1][0][2] = data[5][4];
    t[2][1][1][0] = data[5][3];  t[2][1][1][1] = data[5][1];  t[2][1][1][2] = data[5][5];
    t[2][1][2][0] = data[5][4];  t[2][1][2][1] = data[5][5];  t[2][1][2][2] = data[5][2]; 
    t[1][2][0][0] = data[5][0];  t[1][2][0][1] = data[5][3];  t[1][2][0][2] = data[5][4];
    t[1][2][1][0] = data[5][3];  t[1][2][1][1] = data[5][1];  t[1][2][1][2] = data[5][5];
    t[1][2][2][0] = data[5][4];  t[1][2][2][1] = data[5][5];  t[1][2][2][2] = data[5][2]; 
//    t[2][1] = t[1][2] = {{data[5][0], data[5][3], data[5][4]},
//               {data[5][3], data[5][1], data[5][5]},
//               {data[5][4], data[5][5], data[5][2]}};                   
    return Tensor<4,3,Number>(t);
  }
}
